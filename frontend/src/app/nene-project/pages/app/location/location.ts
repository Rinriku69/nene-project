...
import { MapPosition, PositionUpdate, ResourceErrorResponse } from '../../../models/Resource';
import { StateService } from '../../../services/state.service';

const TIME_OUT = 5 * 1_000;
const MAX_AGE = 0;
  ...
  constructor() {
    afterRenderEffect(() => {
     ...
     if(currentPosition && leafletMap){
      ...
      this.myMarker.set(L.marker([lat,long]).addTo(leafletMap))
      leafletMap.setView([lat,long],leafletMap.getZoom(),{
        animate:true
      })
     }
